// Verbatim GLSL from the supplied BlackHoleHeroSection reference component.
// Not modified — only the surrounding TypeScript harness (in blackhole.ts)
// was adapted from a React effect to a plain mount/cleanup function.
