STRINGS = {
    ...
    "progress": "{assigned} / {total} pages dated ({pct}%)",
    ...
    "upload_opening": "Opening PDF…",
    "upload_preparing_first_page": "Preparing first page…",
    "upload_limit_note": "Maximum file size: {limit} MB.",
    ...
    "ready_to_sort": "All pages dated — ready to sort.",
    "sort_summary_line": "Oldest first · original order preserved for matching dates.",
    "sort_summary_counts": "{assigned} / {total} dated · {unassigned} remaining",
    "date_range_summary": "Date range: {earliest} – {latest}",
